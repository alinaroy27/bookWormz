...
<label className="swap swap-rotate">
  ...
  <a className="bg-pink-500 text-white px-3 py-2 rounded-md hover:bg-pink-800 duration-300 cursor-pointer" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login </a>
  <Login/>
</div>
